...
/**
 * A set of functions called "actions" for `Produit`
 */
...
module.exports = {
  ...
  /**
   * Add an entry to a specific Produit.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific Produit.
   *
   * @return {Object}
   */
