...
/**
 * A set of functions called "actions" for `Productprice`
 */

module.exports = {

  /**
   * Get Productprice entries.
   *
   * @return {Object|Array}
   */
  ...
  /**
   * Add an entry to a specific Productprice.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific Productprice.
   *
   * @return {Object}
   */
