...
/**
 * A set of functions called "actions" for `Producttype`
 */

module.exports = {

  /**
   * Get Producttype entries.
   *
   * @return {Object|Array}
   */
  ...
  /**
   * Add an entry to a specific Producttype.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific Producttype.
   *
   * @return {Object}
   */
